...
type UserSettings struct {
	Id                  uint64      `json:"id"                  orm:"id"                   description:"设置ID，主键"`                         // 设置ID，主键
	UserId              uint64      `json:"userId"              orm:"user_id"              description:"用户ID，外键关联users表"`                 // 用户ID，外键关联users表
	...
	NotificationEnabled int         `json:"notificationEnabled" orm:"notification_enabled" description:"通知开关：0-关闭，1-开启"`                  // 通知开关：0-关闭，1-开启
	AutoSaveSessions    int         `json:"autoSaveSessions"    orm:"auto_save_sessions"   description:"自动保存会话：0-关闭，1-开启"`                // 自动保存会话：0-关闭，1-开启
	MaxSessions         uint        `json:"maxSessions"         orm:"max_sessions"         description:"最大保存会话数量，超出后自动删除最旧的"`             // 最大保存会话数量，超出后自动删除最旧的
