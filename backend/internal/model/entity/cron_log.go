...
type CronLog struct {
	Id         string      `json:"id"         orm:"id"          description:"日志ID"`                 //
	ExecuteId  string      `json:"executeId"  orm:"execute_id"  description:"关联执行记录ID"`             //
	CronId     string      `json:"cronId"     orm:"cron_id"     description:"关联定时任务ID"`             //
