...
func newLambda5(ctx context.Context, conf *common.Config) (lba *compose.Lambda, err error) {
...
func newLambda6(ctx context.Context, conf *common.Config) (lba *compose.Lambda, err error) {
	// TODO Modify component configuration here.
	config := &react.AgentConfig{}
