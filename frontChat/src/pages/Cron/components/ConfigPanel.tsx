...
const ConfigPanel: React.FC<ConfigPanelProps> = ({ form, mode, enabled, paused, onSave, onRunNow, onEnableToggle, onPauseResume, isTablet, selectedKnowledge, knowledgeSelectorRef, onKnowledgeChange }) => {
