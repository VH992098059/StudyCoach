  ...
  useEffect(() => {
    ...
    if (raw) {
      try {
        ...
        if (cfg.kbId === undefined || cfg.kbId === null || cfg.kbId === 'default') {
          cfg.kbId = 'none';
        }
      ...
      form.setFieldsValue({ mode: 'daily', time: dayjs('09:00:00', 'HH:mm:ss'), updateType: 'incremental', kbId: 'none', minuteOfHour: 0, secondOfMinute: 0 });
    }
